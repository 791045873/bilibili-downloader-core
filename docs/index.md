# bilibili-downloader-core Docs Index

## Purpose

This `docs/` tree is the durable memory and routing surface for `bilibili-downloader-core`.
...
| Understand the current app-layer baseline                            | `docs/design/app-overview.md`                         | `docs/design/feature-inventory.md`                                                                      |
...
| Review recent implementation history                                 | `docs/logs/`                                          | the latest dated log file                                                                               |
| Look up a past subtle regression                                     | `docs/bugs/`                                          | the relevant file in `docs/bugs/`                                                                       |
| Record or review exploratory/manual testing                          | `docs/testing/`                                       | the relevant dated test note                                                                            |
