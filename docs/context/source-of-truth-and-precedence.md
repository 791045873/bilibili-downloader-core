...
- API route definitions in `packages/server/src/`
- Core port interfaces in `packages/core/src/`
...
- Bilibili API adapter code in `packages/adapters/src/bilibili/`
- ffmpeg integration in `packages/adapters/src/`
