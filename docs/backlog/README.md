...
| 7 | 2 | P1 | 视频分析-多链接解析前端（4b） | `docs/requirements/2026-07-07-multi-link-parsing-4b.md` | `docs/design/app-overview.md`（待扩展） | `docs/plans/2026-07-07-link-parsing-frontend-4b-plan.md` | `in-progress` | `plan-first` | `none (plan audit passed 2026-07-12)；依赖 Seq 3 (4a) 实现完成` | 2026-07-14 |
