...
| 6 | 2 | P1 | 视频分析-截图源回退（3b） | `docs/requirements/2026-07-07-screenshot-source-fallback-3b.md` | `docs/design/app-overview.md`（待扩展） | `docs/plans/2026-07-07-screenshot-fallback-3b-plan.md` | `in-progress` | `plan-first` | `none (plan audit passed 2026-07-12)；依赖 Seq 2 (3a) 实现完成` | 2026-07-14 |
