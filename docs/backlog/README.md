...
| 5 | 2 | P1 | 视频分析-文档结构优化 | `docs/requirements/2026-07-07-document-structure-optimization.md` | `docs/design/app-overview.md`（待扩展） | `docs/plans/2026-07-07-document-structure-optimization-plan.md` | `in-progress` | `plan-first` | `none (plan audit passed 2026-07-12)` | 2026-07-14 |
| 6 | 2 | P1 | 视频分析-截图源回退（3b） | `docs/requirements/2026-07-07-screenshot-source-fallback-3b.md` | `docs/design/app-overview.md`（待扩展） | `docs/plans/2026-07-07-screenshot-fallback-3b-plan.md` | `ready` | `plan-first` | `none (plan audit passed 2026-07-12)；依赖 Seq 2 (3a) 实现完成` | 2026-07-12 |
| 7 | 2 | P1 | 视频分析-多链接解析前端（4b） | `docs/requirements/2026-07-07-multi-link-parsing-4b.md` | `docs/design/app-overview.md`（待扩展） | `docs/plans/2026-07-07-link-parsing-frontend-4b-plan.md` | `ready` | `plan-first` | `none (plan audit passed 2026-07-12)；依赖 Seq 3 (4a) 实现完成` | 2026-07-12 |
| 8 | 3 | P1 | 视频分析-AI 总结触发（5b） | `docs/requirements/2026-07-07-ai-summary-interaction-5b.md` | `docs/design/app-overview.md`（待扩展） | `docs/plans/2026-07-07-ai-summary-trigger-5b-plan.md` | `ready` | `plan-first` | `none (plan audit passed 2026-07-12)；依赖 Seq 4/5/6/7 实现完成` | 2026-07-12 |
| 9 | 4 | P2 | 视频分析-AI 总结邮件通知（5d） | `docs/requirements/2026-07-07-ai-summary-interaction-5d.md` | `docs/design/app-overview.md`（待扩展） | `docs/plans/2026-07-07-ai-summary-email-5d-plan.md` | `ready` | `plan-first` | `none (plan audit passed 2026-07-12)；依赖 Seq 8 (5b) 实现完成` | 2026-07-12 |
